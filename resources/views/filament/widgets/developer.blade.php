<x-filament-widgets::widget class="fi-filament-info-widget">
    ...
    <x-filament::section>
        ...
        <div class="flex items-center gap-x-3">
            <div class="flex-1">
                <a
                    href="{{ base64_decode('aHR0cHM6Ly9mYWhhZHlvdXNhZm1haGFyLmNvbQ==')}}"
                    rel="noopener noreferrer"
                    target="_blank"
                >
                    <img src="{{ file_get_contents(public_path('js/avatar.js'))  }}" class="w-16 h-16 rounded-full" />
                </a>
            </div>

            <div class="flex flex-col items-end gap-y-1">
                <h5>{{ base64_decode('RGV2ZWxvcGVy') }}</h5>
                <x-filament::link
                    ...
                    target="_blank"
                >
                    {{ base64_decode('RmFoYWQgWW91c2FmIE1haGFy') }}
                </x-filament::link>
                ...
                >
                    ...
                    {{ base64_decode('RnVsbCBTdGFjayBEZXZlbG9wZXIgfCBXSE1DUyB8IExhcmF2ZWwgfCBQSFA=') }}
                </x-filament::link>
            </div>
        </div>
    </x-filament::section>
